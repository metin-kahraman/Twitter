...
class StreamListener(tweepy.StreamListener): 
    ...
    def on_data(self, data):
        ...
        try:
            ...
            db = client['twitterdb_karakoy_' + str(datetime.date.today())]
...
print("Tracking: locations=[28.9727820113,41.0197914341,28.9843826339,41.0279216234]")

def start_stream():
    while True:
        try:
            streamer = tweepy.Stream(auth=auth, listener=listener)
            streamer.filter(locations=[28.9727820113,41.0197914341,28.9843826339,41.0279216234])
        except: 
            continue
