...
for x in mycol.find({'place.country_code': {"$in": ["AL","AD","AT","BY","BE","BA","BG","HR","CY","CZ","DK","EE","FO","FI","FR","DE","GI","GR","HU","IS","IE","IM","IT","XK","LV","LI","LT","LU","MK","MT","MD","MC","ME","NL","NO","PL","PT","RO","RU","SM","RS","SK","SI","ES","SE","CH","UA","GB","VA"]}},{"retweeted_status.entities.hashtags.text":1,"entities.hashtags.text":1,"_id":0}) : #"entities.hashtags.text":1 ,"_id":0
...
path = 'D:\python_out\\nov_eu_out.json' # dosya yolu belirtildi
